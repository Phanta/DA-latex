...
\begin{table}[hbt]
\centering
\caption[Paket- und Klassen"ubersicht]{Paket- und Klassen"ubersicht: Paketnamen sind in \texttt{True-Type} und Klassennamen als \textsf{serifenloser} Schriftart bezeichnet}
...
Die Suche nach einer Samplenummer kann sowohl vor- als auch r"uckw"arts erfolgen.
