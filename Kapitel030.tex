...
- Singleton Konzept erkl"aren \cite{Gamma1995} (Seite 127 bis 134)
...
\paragraph{Anmerkung zur Quick-Sort-Implementierung}
...
\subsubsection{[WIP]Direkter Zugriff auf Werte mit der Klasse \class{BufferedValueController}}
