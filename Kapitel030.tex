...
\caption[UML-Paket-"Ubersicht der umgesetzten Software]{UML-Paket-"Ubersicht der umgesetzten Software, nur wesentliche Klassen sind dargestellt}
\label{pic:paket_ubersicht}
\end{figure}

-- theoretische beschreibung des gesamtkonzeptes
-- auflisten der subkomponenten siehe \picref{paket_ubersicht}
...
\caption[UML-Diagramm des \texttt{data}-Paketes]{UML-Diagramm des \texttt{data}-Paketes inklusive der bereitgestellten Schnittstellen}
\label{pic:data_package}
\end{figure}

siehe \picref{data_package}
