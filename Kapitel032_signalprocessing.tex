...
Das Paket \code{signalprocessing} ist daf"ur ausgelegt, dass es um weitere Signalverarbeitungsfunktionen einfach erweitert werden kann.
...
Das Abbrechen der kontinuierlichen Signalverarbeitung durch den Nutzer ist in der vorgelegten Implementierung schon integriert.
