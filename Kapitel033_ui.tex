...
Um auf Eingaben des Benutzers reagieren zu k"onnen, besitzt die Klasse \class{SignalView} zwei innere Klassen: \class{Signal\-View\-Mouse\-Adapter} und \class{Signal\-View\-Key\-Adapter}.
Jedes \class{SignalView}-Objekt besitzt jeweils eine Objektinstanz dieser beiden Klassen.
