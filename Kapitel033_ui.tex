...
- Dreiecksbeziehung von \class{AnnotationController}, \class{AnnotationList} und \class{AnnotationManager} erl"autern
- Suchalgorithmus zum finden der aktuellen Annotation
- "Anderung wird durch die Implementierung vom Interface \class{DataChangeListener} automatisiert aktualisiert
