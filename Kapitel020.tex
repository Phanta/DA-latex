...
Die Methodik abstrakter Klassen wird insbesondere im \code{signalprocessing}-Paket genutzt und ist im \secref{signalprocessing} beschrieben. \cite{Barnes2003a}
