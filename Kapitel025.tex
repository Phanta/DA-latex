...
\begin{enumerate}
	...
	\AF{diagramm} muss in der Lage sein, die Signalverl"aufe sowohl einzeln (1) in einem Diagramm daszustellen, aber auch mehrere verschieden Signalverl"aufe (2) in ein und demselben Diagramm zu visualisieren.
...
Folgend sollen die Testszenarien beschrieben werden die zur Validierung der Software durch gef"uhrt werden sollen.
